...
import jihuayu.patchoulitask.old.net.C2SRewardGetPacket;
...
public class BaseTaskPage extends PageQuest {
    ...
    public boolean render1(int mouseX, int mouseY, float pticks) {
        ...
        if (reward.size() > 0) {
            parent.drawCenteredStringNoShadow(I18n.format("patchouliquests.task.reward",1,1),
                    fontRenderer.getStringWidth(I18n.format("patchouliquests.task.reward",1,1)) / 2 + 4, recipeY - 6, book.textColor);
